                            ...
                            <div class="col-md-9 home-top-cour-desc">
                                ...
                                <div class="hom-list-share">
                                    <ul>
                                        ...
                                        <li><a href="{{route("allBooks")}}"><i class="fa fa-eye" aria-hidden="true"></i>10 Aavailable</a> </li>
                        ...
                        <div class="home-top-cour">
                            ...
                            <div class="col-md-9 home-top-cour-desc">
                                ...
                                <div class="hom-list-share">
                                    <ul>
                                        <li><a href="{{route("booksDetails")}}"><i class="fa fa-bar-chart" aria-hidden="true"></i> Book Now</a> </li>
                                        <li><a href="{{route("allBooks")}}"><i class="fa fa-eye" aria-hidden="true"></i>40 Aavailable</a> </li>
                        ...
                        <div class="home-top-cour">
                            ...
                            <div class="col-md-9 home-top-cour-desc">
                                ...
                                <div class="hom-list-share">
                                    <ul>
                                        <li><a href="{{route("booksDetails")}}"><i class="fa fa-bar-chart" aria-hidden="true"></i> Book Now</a> </li>
                                        <li><a href="{{route("allBooks")}}"><i class="fa fa-eye" aria-hidden="true"></i>04 Aavailable</a> </li>
                        ...
                        <div class="home-top-cour">
                            ...
                            <div class="col-md-9 home-top-cour-desc">
                                ...
                                <div class="hom-list-share">
                                    <ul>
                                        <li><a href="{{route("booksDetails")}}"><i class="fa fa-bar-chart" aria-hidden="true"></i> Book Now</a> </li>
                                        <li><a href="{{route("allBooks")}}"><i class="fa fa-eye" aria-hidden="true"></i>32 Aavailable</a> </li>
